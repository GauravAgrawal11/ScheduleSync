...
export const translations = {
  en: {
    ...
    pwa_modal_title_ios: 'How to Install on iPhone / iPad (iOS)',
    pwa_modal_title_android: 'How to Install on Android',
    pwa_modal_title_desktop: 'How to Install on Desktop (Chrome / Edge)',
    pwa_ios_step1: 'Tap the Share button (⎋) at the bottom bar of Safari.',
    pwa_ios_step2: "Scroll down the share sheet and tap 'Add to Home Screen' (⊞).",
    pwa_ios_step3: "Tap 'Add' in the top-right corner to add ScheduleSync to your home screen.",
    pwa_android_step1: 'Tap the three-dots menu (⋮) in the top-right corner of Chrome.',
    pwa_android_step2: "Tap 'Install app' or 'Add to Home screen'.",
    pwa_android_step3: "Tap 'Install' in the prompt to add ScheduleSync to your app drawer.",
    pwa_desktop_step1: 'Click the Install icon (⊕ / ⤓) on the right side of the address bar.',
    pwa_desktop_step2: "Or click browser menu (⋮) and select 'Install ScheduleSync'.",
    pwa_modal_close: 'Got It',
  ...
  hi: {
    ...
    pwa_modal_title_ios: 'iPhone / iPad (iOS) पर कैसे इंस्टॉल करें',
    pwa_modal_title_android: 'Android पर कैसे इंस्टॉल करें',
    pwa_modal_title_desktop: 'कंप्यूटर / लैपटॉप पर कैसे इंस्टॉल करें',
    pwa_ios_step1: 'Safari में नीचे शेयर बटन (Share ⎋) पर टैप करें।',
    pwa_ios_step2: "शेयर मेनू में नीचे स्क्रॉल करें और 'होम स्क्रीन में जोड़ें' (Add to Home Screen ⊞) चुनें।",
    pwa_ios_step3: "ऊपर दाईं ओर 'Add' पर टैप करके शेड्यूलसिंक को होम स्क्रीन पर जोड़ें।",
    pwa_android_step1: 'Chrome में ऊपर दाईं ओर 3 डॉट्स (⋮) मेनू पर टैप करें।',
    pwa_android_step2: "'ऐप इंस्टॉल करें' (Install app) या 'होम स्क्रीन में जोड़ें' (Add to Home screen) चुनें।",
    pwa_android_step3: "पुष्टि के लिए 'Install' पर टैप करें — ऐप आपके मोबाइल में जुड़ जाएगा।",
    pwa_desktop_step1: 'एड्रेस बार में दाईं ओर इंस्टॉल आइकन (⊕ / ⤓) पर क्लिक करें।',
    pwa_desktop_step2: "या ब्राउज़र मेनू (⋮) खोलकर 'Install ScheduleSync' चुनें।",
    pwa_modal_close: 'समझ गया / बंद करें',
